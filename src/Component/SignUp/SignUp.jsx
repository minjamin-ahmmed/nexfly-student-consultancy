        ...
        <div className="mt-5 md:mt-10 lg:mt-24">
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-0 items-center px:5 md:px-10 lg:px-28">
                ...
                <div className="lg:w-1/3 px-5 lg:px-0">
                    <h1 className="text-3xl font-semibold text-start mb-6">Sign Up to your Nexfly Account</h1>
                    <form>
                        ...
                        <div className="form-control relative">
                            <input type={showPassword ? 'text' : 'password'} placeholder="Confirm Password" className="input input-bordered w-full border border-[#CBD5E1] placeholder-slate-700 font-medium" required />
                            <label className="label">
                                <button onClick={() => setShowPassword(!showPassword)} className="absolute top-4 right-4">
                                    {
                                        showPassword ? <IoEye /> : <IoEyeOffSharp />
                    ...
                    <p className="font-medium text-sm text-zinc-900 text-center my-6">Already Sign up? <span className="text-indigo-500">sign in</span> </p>
                </div>
