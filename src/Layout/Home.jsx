    ...
    <div className="w-full mx-auto">
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <img
              className="w-full lg:h-[400px] lg:rounded-xl object-cover"
              src={modalImg}
              alt="Scholarship"
            />
          </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <h2 className="text-xl font-Poppins text-start md:text-2xl lg:text-4xl font-medium text-black">
                Tech Excellence{" "}
                <span className="text-indigo-500">Scholarship!</span>
              </h2>
              <p className="font-bold text-start">
                Up to 50% tuition fee waiver
              </p>
              <p className="text-slate-900 font-normal text-sm text-justify">
                Undergraduate or master's students in Computer Science, Data
                Science, Artificial Intelligence, or related fields. Minimum
                GPA: 3.5 (on a 4.0 scale). Demonstrated leadership in tech
                projects or hackathons.
              </p>
