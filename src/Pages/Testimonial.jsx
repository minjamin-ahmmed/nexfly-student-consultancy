...
const Testimonial = () => {
    ...
    const testimonials = [
        {
            heading: "Working with Master in me has been an incredibly painless and enjoyable experience",
            name: "Manuel Rokib",
    ...
    return (
        <div className="px-5 md:px-10 lg:px-20 py-5 md:py-10 lg:py-20">
            ...
            <p className="font-Manrope text-md lg:text-lg text-[#334155] mb-10 lg:w-1/2">We provide exceptional support and resources to make your study abroad journey smooth and successful.</p>
                        ...
                        testimonials.map((testimonial, index) => (
                            <div key={index} className="p-5">
                                ...
                                <div className="flex flex-col lg:flex-row items-center justify-center">
                                    <div className="lg:w-2/3 bg-indigo-500 text-center rounded-t-xl lg:rounded-l-xl lg:rounded-r-none py-10 lg:py-24">
                                        <h1 className="text-white text-2xl font-normal mb-10">{testimonial.heading}</h1>
                                        <p className="text-white text-lg font-medium">{testimonial.name} <span className="text-[#CBD5E1] font-normal text-lg">{testimonial.companyName}</span> </p>
                                    </div>

                                    <div className="w-full lg:w-1/3">
                                        <img className="w-full  h-[300px] lg:h-[324px] rounded-b-2xl lg:rounded-r-2xl lg:rounded-b-none object-cover" src={testimonial.image} alt="" />
                                    </div>
                                </div>
