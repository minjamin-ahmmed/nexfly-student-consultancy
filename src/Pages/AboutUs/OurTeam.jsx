...
const OurTeam = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-20 mb-20">
            <div className="space-y-3 mb-12">
                <h1 className="font-Poppins font-medium text-xl md:text-2xl lg:text-4xl">Our Team</h1>
                <p className="text-slate-500 font-normal lg:w-1/2">We provide exceptional support and resources to make your study abroad journey smooth and successful.</p>
            </div>
                        ...
                        teamMembers.map((member, index) => (
                            ...
                            <div key={index} className="p-5">
                                <div className="p-2">
                                    ...
                                    <h3 className="mb-1 font-Poppins text-xl font-medium"> {member.name} </h3>
