...
const Events = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-20 py-10 mb-10">
            <h1 className="font-Poppins font-medium text-[#0F172A] text-2xl md:text-3xl lg:text-4xl mb-4">Events</h1>
            ...
            <div className="relative mt-10 ">
                <Slider {...settings}>
                    {
                        incident.map((event, index) => <div key={index} className=" pr-9">
                            <div className="shadow-2xl">
                                <div className="mb-4">
                                    <img className="w-full" src={event.image} alt="" />
                                </div>
                                <div className="p-2">
                                    <h3 className="text-[#0F172A] font-Poppins text-xl mb-3">{event.name}</h3>
                                    <div className="flex items-center gap-4 mb-3">
                                        <img src={clockElement} alt="" />
                                        <p className="text-indigo-500"> 22 Oct, 2024; 8:00 PM </p>
                                    </div>
                                    <p className="text-[#64748B] font-medium font-Manrope text-lg mb-3">{event.description}</p>
